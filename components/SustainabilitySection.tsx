      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-slate-600 leading-relaxed">
            Als Handwerker tragen wir Verantwortung für Brambauer und die Umwelt. 
            Wir setzen auf modernste Technologien, die Emissionen senken und Ihre Heizkosten langfristig minimieren.
          </p>
        </div>

        {/* YOUTUBE VIDEO BEREICH */}
        <div className="max-w-5xl mx-auto mb-20">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-black aspect-video group">
            <iframe 
              width="100%" 
              height="100%" 
              src="https://www.youtube-nocookie.com/embed/dz6dj3pQh1Q?rel=0&modestbranding=1" 
              title="Wärme Pur Erklärvideo" 
              frameBorder="0" 
          ...
          <div className="flex justify-center mt-8">
             <div className="flex items-center gap-3 bg-slate-50 border border-slate-200 px-6 py-3 rounded-full shadow-sm">
                ...
                <div>
                  <div className="font-bold text-slate-900 text-sm">So funktioniert das Prinzip Wärmepumpe</div>
                  <div className="text-slate-500 text-xs">Einfach erklärt: Die Technik der Zukunft in wenigen Minuten.</div>
                </div>
             </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-slate-50 rounded-2xl p-8 border border-slate-100 hover:border-red-100 transition-colors">
            ...
            <p className="text-slate-600 leading-relaxed text-sm">
              Mit einer modernen Wärmepumpe sparen Sie bis zu 70% CO₂ gegenüber einer alten Ölheizung ein. 
              Ein echter Beitrag zum Klimaschutz direkt aus Ihrem Keller.
            </p>
          </div>
          ...
          <div className="bg-slate-50 rounded-2xl p-8 border border-slate-100 hover:border-orange-100 transition-colors">
            ...
            <p className="text-slate-600 leading-relaxed text-sm">
              Machen Sie sich frei von steigenden Gas- und Ölpreisen. Nutzen Sie die kostenlose Energie 
              der Umwelt und machen Sie Ihr Zuhause zukunftssicher.
            </p>
          </div>
          ...
          <div className="bg-slate-50 rounded-2xl p-8 border border-slate-100 hover:border-blue-100 transition-colors">
            ...
            <p className="text-slate-600 leading-relaxed text-sm">
              Der Staat zahlt mit! Wir sind Experten für Fördermittel und helfen Ihnen dabei, 
              die maximale Förderung für Ihre neue umweltfreundliche Heizung zu sichern.
            </p>
          </div>
