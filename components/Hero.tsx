        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          <div className="w-full lg:w-1/2 order-2 lg:order-1">
            <div className="flex items-center gap-4 mb-6">
              <span className="bg-red-600 text-white text-xs font-bold px-3 py-1 uppercase tracking-widest">Neuheit</span>
              <span className="text-zinc-400 text-sm uppercase tracking-wider">Die Zukunft des Heizens</span>
              <div className="hidden md:flex items-center gap-1.5 border-l border-zinc-800 pl-4">
                ...
                <span className="text-xs text-zinc-500 font-bold ml-2">Top Bewertung</span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-5 mb-12">
              <button onClick={onCtaClick} className="group relative overflow-hidden bg-white text-black px-8 py-4 font-black text-lg uppercase tracking-wider flex items-center gap-3">
                ...
                <span className="absolute inset-0 flex items-center justify-center gap-3 text-white opacity-0 group-hover:opacity-100 transition-opacity">Angebot sichern <ArrowRight size={20} /></span>
              </button>
              <a href="#calculator" className="flex items-center gap-2 px-8 py-4 border border-zinc-700 text-white hover:border-red-600 hover:text-red-500 transition-colors font-bold uppercase tracking-wider">
                <Zap size={18} /> Spar-Rechner
              </a>
            </div>
            <div className="grid grid-cols-2 gap-6 border-t border-zinc-800 pt-8">
              <div className="flex gap-3"><CheckCircle className="text-red-600 mt-1" /><div><strong className="text-white block">Extrem leise</strong><span className="text-sm text-zinc-500">Kaum hörbar</span></div></div>
              <div className="flex gap-3"><CheckCircle className="text-red-600 mt-1" /><div><strong className="text-white block">Smart Home</strong><span className="text-sm text-zinc-500">App-Steuerung</span></div></div>
            </div>
          </div>
          ...
          <div className="w-full lg:w-1/2 order-1 lg:order-2 relative flex justify-center">
            ...
            <div className="relative z-10 w-full max-w-xl animate-float-slow">
              <img src="/pumpe.png" alt="Wärme Pur Wärmepumpe" className="w-full h-auto rounded-xl shadow-2xl" />
              <div className="absolute -bottom-6 -left-4 md:bottom-10 md:-left-12 z-20">
                <div className="bg-white/10 backdrop-blur-md border border-white/20 p-3 pr-5 rounded-2xl shadow-2xl flex gap-3">
                  <div className="w-12 h-12 bg-gradient-to-br from-blue-100 to-white rounded-full flex items-center justify-center"><Snowflake className="text-blue-500 w-6 h-6" /></div>
                  <div><div className="text-white font-bold text-sm">Polar-Effizienz</div><div className="text-blue-200 text-xs">Leistung bis −25 °C</div></div>
                </div>
              </div>
            </div>
          </div>
